...
\cvitem{Relational}{
    Relational, a relational algebra parser/compiler/optimizer. Implemented in Python
    \newline
    It can compile and execute relational algebra, and perform optimizations.
    It is used by several schools and univerities across the world.
    \newline
...
\cvitem{localslackirc}{
    Python daemon to bridge slack (the chat) with IRC.
    \newline
...
\cvitem{Subsurface}{The only divelog available on Linux systems.
    \newline
    Packaging and portability and localization, and a functionality to export the logs on a website I made.}
\cvitem{Debian}{
...
\section{Interests}
\cvlistdoubleitem{Playing music}{Board games}
